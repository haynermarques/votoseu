...
class SessaolegislativaTable extends SupabaseTable<SessaolegislativaRow> {
  @override
  String get tableName => 'sessaolegislativa';

  @override
  SessaolegislativaRow createRow(Map<String, dynamic> data) =>
      SessaolegislativaRow(data);
}

class SessaolegislativaRow extends SupabaseDataRow {
  SessaolegislativaRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => SessaolegislativaTable();
