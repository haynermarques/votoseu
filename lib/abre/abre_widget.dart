                  ...
                  child: FutureBuilder<List<CompleteVotesSummaryRow>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<CompleteVotesSummaryRow>
                          listViewCompleteVotesSummaryRowList = snapshot.data!;

                      return ListView.separated(
                        padding: EdgeInsets.zero,
                        shrinkWrap: true,
                        scrollDirection: Axis.vertical,
                        itemCount: listViewCompleteVotesSummaryRowList.length,
                          ...
                          return InkWell(
                            ...
                            child: wrapWithModel(
                              model: _model.listaSessaoModels.getModel(
                                listViewCompleteVotesSummaryRow.id!.toString(),
                                listViewIndex,
                              ),
                              updateCallback: () => safeSetState(() {}),
                              child: ListaSessaoWidget(
                                ...
                                titulo: listViewCompleteVotesSummaryRow
                                    .txttituloreuniao!,
                                dtabertura:
                                    listViewCompleteVotesSummaryRow.abertura!,
                                legislatura: listViewCompleteVotesSummaryRow
                                    .sessaoLegislativa!,
                                sessao: listViewCompleteVotesSummaryRow
                                    .numeroSessao!
                                    .toString(),
                                tipo:
                                    listViewCompleteVotesSummaryRow.tipoSessao!,
                                ttsim:
                                    listViewCompleteVotesSummaryRow.totalSim!,
                                ttnao:
                                    listViewCompleteVotesSummaryRow.totalNao!,
                                ttabt: listViewCompleteVotesSummaryRow
                                    .totalAbstencao!,
                                ttvoto:
                                    listViewCompleteVotesSummaryRow.totalVotes!,
                              ),
                            ),
                          );
                        },
